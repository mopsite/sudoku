...
setCells(board2.value, [[1, 2, '★'], [7, 1, '★'], [8, 1, '★'], [3, 1, 2], [3, 7, 2], [9, 2, 2], [9, 7, 2]])
const specialCells2 = [
  {cells: ['r3c1', 'r3c7', 'r9c2', 'r9c7'], classes: 'bg-purple font-small'}
]
...
setCells(board4.value, [[1, 1, '★'], [1, 7, 1], [3, 9, 1], [5, 1, 1], [5, 9, 1]])
const specialCells4 = [
  {cells: ['r1c7', 'r3c9', 'r5c1', 'r5c9'], classes: 'bg-purple font-small'}
]

const board5 = ref(getBoard(str3))
setCells(board5.value, [[1, 1, '★'], [3, 2, 1], [3, 9, 1], [5, 1, 1], [5, 9, 1]])
const specialCells5 = [
  {cells: ['r3c2', 'r3c9', 'r5c1', 'r5c9'], classes: 'bg-purple font-small'}
]
...
setCells(board6.value, [[4, 2, '1=9'], [4, 8, '9=4'], [5, 1, '1=4']])
const specialCells6 = [
  {cells: ['r4c2', 'r4c8', 'r5c1'], classes: 'bg-purple font-small'}
]
...
setCells(board7.value, [[4, 2, '6=8'], [4, 9, '8=1'], [5, 1, '1=7'], [5, 2, '7=6']])
const specialCells7 = [
  {cells: ['r4c2', 'r4c9', 'r5c1', 'r5c2'], classes: 'bg-purple font-small'}
]
...
const specialCells8 = [
  {cells: ['r1c2', 'r1c4', 'r2c2', 'r5c2', 'r5c4'], classes: 'bg-purple font-small'}
]
...
setCells(board9.value, [[8, 5, '4=7'], [8, 7, '7=1'], [9, 5, '4=9'], [9, 7, '9=1']])
const specialCells9 = [
  {cells: ['r8c5', 'r8c7', 'r9c5', 'r9c7'], classes: 'bg-purple font-small'}
]
</script>
...
1. 左上格是 1，则中上格和右中格一定不是 1；
2. 中上格是 1，则左上格和右中格一定不是 1；
3. 右中格是 1，则左上格和中上格一定不是 1。
...
1. 如果这格位 1，则不能为 2 或 3；
2. 如果这格为 2，则不能为 1 或 3；
3. 如果这格为 3，则不能为 1 或 2；
  ...
  <table class="re">
    <tbody>
      ...
      <tr>
        <td>真</td>
        <td>真</td>
        <td><span style="color: var(--pink);">假</span></td>
        <td><span style="color: var(--pink);">真</span></td>
      </tr>
      <tr>
        <td>真</td>
        <td>假</td>
...
1. R3C1 = 2
2. R3C1 ≠ 2，则 R3C7 = 2（强关系），R9C7 ≠ 2（弱关系），R9C2 = 2（强关系）
